...
libraryDependencies += "com.lkroll.roll20" %%% "roll20-core" % "0.13.0-SNAPSHOT"
...
libraryDependencies += "com.lkroll.roll20" %%% "roll20-sheet-model" % "[0.11.0-SNAPSHOT,)" % "provided" // needed for APIOutputTemplate fields
